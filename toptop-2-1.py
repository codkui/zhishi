...
class BaiduSpider(object):
    ...
    def _spider(self,answer,questWork):
        stTime=time.time()
    ...
    def start(self,answer,ques):
        self._spider(answer,ques)



if '__main__' == __name__:
    strs="12.1799年乾隆皇帝去世，同年去世的另外一位美国总统是谁?"
    ansss=[u"华盛顿",u"斯大林",u"拿破仑"]
    ...
    baidu_spider.start(ansss,quesArray)
    print "测试通过"
    lastQ=""
    while True:
        ...
        try:
            ...
            if lastQ!=ques:
                ...
                lastQ=ques
                baidu_spider = BaiduSpider(ques,1)
                baidu_spider.start(ans,quesArray)
                print ques
